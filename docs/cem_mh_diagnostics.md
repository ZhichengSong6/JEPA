...
prefix step and the rendered solve-start image. Compare official preprocessed
pixels with the native rendering. Also replay the actually returned action plan
